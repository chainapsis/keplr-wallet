...
export class ObservableQueryIbcSwap extends HasMapStore<ObservableQueryIBCSwapInner> {
  ...
  > {
    ...
    entry.currencies.push({
      ...
      coinGeckoId: "namada",
      coinImageUrl:
        "https://raw.githubusercontent.com/chainapsis/keplr-chain-registry/main/images/osmosis/ibc/C7110DEC66869DAE9BE9C3C60F4B5313B16A2204AE020C3B0527DD6B322386A3.png",
    });
