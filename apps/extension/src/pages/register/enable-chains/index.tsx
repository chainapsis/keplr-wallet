  ...
  ({
    ...
    const numSelected = useMemo(() => {
      ...
      for (const modularChainInfo of chainStore.modularChainInfos) {
        ...
        modularChainInfoMap.set(chainIdentifier, modularChainInfo);
      }

      let numSelected = 0;
      for (const enabledChainIdentifier of enabledChainIdentifiers) {
        if (modularChainInfoMap.has(enabledChainIdentifier)) {
          numSelected++;
        }
      }
      return numSelected;
    }, [chainStore.modularChainInfos, enabledChainIdentifiers]);
                ...
                onClick={(e) => {
                  ...
                  if (
                    ...
                    for (const modularChainInfo of modularChainInfos) {
                      ...
                      if (
                        !newEnabledChainIdentifiers.includes(chainIdentifier)
                      ) {
