...
const IconAboutKeplr: FunctionComponent = () => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M14.48 9.922c.13 1.336.196 2.004.546 2.494.15.21.336.393.547.54.495.343 1.164.4 2.502.512l.566.048v.968l-.566.048c-1.338.112-2.007.169-2.501.512-.212.147-.397.33-.548.54-.35.49-.415 1.158-.546 2.494h-.96c-.13-1.336-.196-2.004-.546-2.494a2.3 2.3 0 0 0-.547-.54c-.495-.343-1.164-.4-2.502-.512l-.566-.048v-.968l.566-.048c1.338-.112 2.007-.169 2.502-.512.211-.147.396-.33.547-.54.35-.49.415-1.158.546-2.494z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M14 5c7.412 0 9 1.588 9 9s-1.588 9-9 9c-7.411 0-9-1.588-9-9 0-7.411 1.588-9 9-9m5.882 3.11C17.702 5.93 13.3 6.8 10.05 10.05s-4.12 7.652-1.94 9.832 6.582 1.312 9.833-1.939c3.25-3.25 4.119-7.653 1.94-9.833"
        clipRule="evenodd"
      />
    </svg>
  );
