      ...
      <YAxis>
        ...
        <MenuItem onClick={(e) => handleToggleClick(e, onToggleShowFiatValue)}>
          <MenuItemXAxis alignY="center" gap="0.5rem">
            ...
            <Body3
              color={
                showFiatValue ? ColorPalette["white"] : ColorPalette["gray-200"]
              }
            >
      ...
      <YAxis>
        <MenuItem onClick={onBackClick}>
          <MenuItemXAxis alignY="center" gap="0.5rem">
            ...
            />
            <Body3 color={ColorPalette["gray-200"]}>Back</Body3>
          </MenuItemXAxis>
        </MenuItem>
...
const AssetViewIcon: FunctionComponent<IconProps> = () => {
  return (
    <div
      style={{
        width: "1rem",
...
const HideLowBalanceIcon: FunctionComponent<IconProps> = () => {
  return (
    <div
      style={{
        width: "1rem",
...
const ShowFiatValueIcon: FunctionComponent<IconProps> = () => {
  return (
    <div
      style={{
        width: "1rem",
...
const GroupByAssetsIcon: FunctionComponent<IconProps> = () => {
  return (
    <div
      style={{
        width: "1rem",
...
const FlatIcon: FunctionComponent<IconProps> = () => {
  return (
    <div
      style={{
        width: "1rem",
