...
function CustomDrawerContent(props) {
  ...
  return (
    ...
    >
      <TouchableHighlight style={{ alignSelf: 'flex-start', padding: 5, marginLeft: 16, marginBottom: 30 }} onPress={() => navigation.closeDrawer()}>
        <FontAwesomeIcon icon={faTimes} style={{ color: '#4d5070' }}></FontAwesomeIcon>
      </TouchableHighlight>
