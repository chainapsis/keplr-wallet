...
export type ReplaceMultisigProposeProps = NativeStackScreenProps<
  OnboardingStackParamList,
  "replace-multisig-propose"
>;

export const ReplaceMultisigPropose = observer<ReplaceMultisigProposeProps>(({ navigation }) => {
