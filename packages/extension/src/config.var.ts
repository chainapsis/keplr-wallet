...
export const EVMOS_RPC_ENDPOINT = "http://localhost:26657";
export const EVMOS_RPC_CONFIG: AxiosRequestConfig | undefined = {
  url: EVMOS_RPC_ENDPOINT,
};
export const EVMOS_REST_ENDPOINT = "http://localhost:1317";
export const EVMOS_REST_CONFIG: AxiosRequestConfig | undefined = {
  url: EVMOS_REST_ENDPOINT,
};
