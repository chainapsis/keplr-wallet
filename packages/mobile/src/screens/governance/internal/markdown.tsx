...
export const MemoizedHtmlRender: FunctionComponent<{
  ...
  return (
    <RenderHtml
      ...
      tagsStyles={{
        h1: style.flatten(["margin-top-8", "margin-bottom-4"]),
        h2: style.flatten(["margin-top-8", "margin-bottom-4"]),
        h3: style.flatten(["margin-top-8", "margin-bottom-4"]),
        h4: style.flatten(["margin-top-8", "margin-bottom-4"]),
        h5: style.flatten(["margin-top-8", "margin-bottom-4"]),
        h6: style.flatten(["margin-top-8", "margin-bottom-4"]),
        p: style.flatten(["margin-top-4", "margin-bottom-4"]),
        ul: style.flatten(["margin-top-4", "margin-bottom-4"]),
        li: style.flatten(["margin-bottom-8"]),
      }}
    />
  );
});
