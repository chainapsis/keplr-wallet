        ...
        <RectButton
          style={style.flatten(
            ...
            [
              ...
              selected && "dark:background-color-blue-600",
            ]
          )}
        ...
        >
          <Text
            style={style.flatten(
              ...
              [selected && "color-blue-400", selected && "dark:color-blue-100"]
            )}
          >
            {label}
          </Text>
          ...
          <Text
            style={style.flatten(
              ...
              [selected && "color-blue-200", selected && "dark:color-blue-300"]
            )}
          >
